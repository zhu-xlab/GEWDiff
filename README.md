...
- **2025.11** 📄 Preprint released on [arXiv](https://arxiv.org/abs/2511.07103). Checkpoint and test data released on [LRZ](https://syncandshare.lrz.de/getlink/fiGcpRBVAU7PRFtyfQjh8r/checkpoints).
...
1. Download a pretrained checkpoint (e.g., `epoch_200.pth`) and place it in `checkpoints/`. Checkpoint and test data released on [LRZ](https://syncandshare.lrz.de/getlink/fiGcpRBVAU7PRFtyfQjh8r/checkpoints).
